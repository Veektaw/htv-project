...
//         <div className="flex min-h-0 w-full flex-col gap-6 lg:flex-row">
//           <div className="border-Iron flex min-h-0 flex-col space-y-8 rounded-lg border px-4 py-6">
//             <div className="flex items-center justify-between gap-4">
//               <div className="space-y-2">
//                 <h2 className="text-MediumGrey text-sm">Invoice</h2>
//                 <h3 className="text-DarkJungleGreen text-2xl font-bold">
...
//           <div className="border-Iron flex flex-col space-y-8 rounded-lg border px-4 py-6 lg:w-80 xl:w-96">
//             <Suspense fallback={<Loader text="Getting notifications..." />}>
//               <RecentNotifications />
//             </Suspense>
//           </div>
